...
public class Es2Config
{
     ...
     * 协议
     */
    @Value("${elasticsearch2.scheme:http}")
    private String scheme;

    /**
     * es集群,如果有多个用“,”隔开
     */
    @Value("${elasticsearch2.clusters}")
     ...
     * 连接超时时间
     */
    @Value("${elasticsearch2.connectTimeout:5000}")
    private int connectTimeout;

    /**
     * Socket 连接超时时间
     */
    @Value("${elasticsearch2.socketTimeout:30000}")
    private int socketTimeout;

    /**
     * 获取连接的超时时间
     */
    @Value("${elasticsearch2.connectionRequestTimeout:5000}")
    private int connectionRequestTimeout;

    /**
     * 最大连接数
     */
    @Value("${elasticsearch2.maxConnectNum:100}")
    private int maxConnectNum;

    /**
     * 最大路由连接数
     */
    @Value("${elasticsearch2.maxConnectPerRoute:100}")
