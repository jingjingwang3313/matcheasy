package cn.matcheasy.framework.config.actuator;

/**
 * 1.  /autoconfig    可以得到配置生效信息
 * 2.  /configprops   可以得到属性的内容和默认值
 * 3.  /beans   	    可以得到bean的别名、类型、是否单例、类的地址、依赖等信息
 * 4.  /dump          可以得到线程名、线程ID、线程的状态、是否等待锁资源等信息
 ...
 * @author: wangjing
 * @date: 2020/11/5/0005
 * @desc: springboot监控:   http://127.0.0.1:8888/actuator
 */
